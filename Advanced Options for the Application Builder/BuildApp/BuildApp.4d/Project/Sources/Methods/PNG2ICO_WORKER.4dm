...
Else 
	...
	$resourcesFolder:=Folder:C1567(fk resources folder:K87:11).folder("windows")
	...
	$dst:=$desktopFolder.file($PROJECT+".ico")
	
	$one:=New object:C1471("src"; $src; "dst"; $dst)
	
	$png2ico:=cs:C1710.Png2Ico.new()
	
	$png2ico.convert(New collection:C1472($one))
