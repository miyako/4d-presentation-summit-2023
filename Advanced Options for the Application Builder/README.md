...
Do you build your 4D app? Do you have an XML project to configure your application exactly how it ought to be? In this session, Keisuke will explain the benefits of building your 4D app and how to take full advantage of the various build options now available in v20.
