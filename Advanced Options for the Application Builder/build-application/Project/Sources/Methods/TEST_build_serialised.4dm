//%attributes = {}
$buildProject:=Folder:C1567(fk database folder:K87:14).file("tests/BuildApplicationSerialized.4DSettings")
...
If (True:C214)
	...
	Else 
		$BuildApp.SourcesFiles.RuntimeVL[$RuntimeVLFolder]:=Folder:C1567(fk applications folder:K87:20).parent.folder("Program Files").file("4D/4D v20.1/4D Volume Desktop"+$appExtension).platformPath
	End if 
