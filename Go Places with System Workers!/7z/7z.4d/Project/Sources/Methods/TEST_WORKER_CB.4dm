...
Else 
	...
	$zipper:=cs:C1710.SevenZip.new(cs:C1710._Worker_Controller)  //the controller will intercept callbacks
	
	$zipper.add($z; $a).add($z; $b).add($z; $c).extract($d; $z)  //chaining syntax
